...
def main():
    ...
    parser.add_argument('-sp', '--savePath', type=str, default="output", help='输出路径')
    parser.add_argument('-fn', '--fileName', type=str, default="output", help='输出文件名')
    ...
    for clean_name, tran in zip(clean_names, trans):
        ...
        for spk in spk_list:
            ...
            # if use_spk_mix:
            #     spk = "spk_mix"
            res_path = f'{savePath}/{fileName}.{wav_format}'
